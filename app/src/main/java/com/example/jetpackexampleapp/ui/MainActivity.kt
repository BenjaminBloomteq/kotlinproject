...
class MainActivity : AppCompatActivity(), HasSupportFragmentInjector {
    ...
    private fun toSignUp() { // sets fragment to register fragment
        ...
        supportFragmentManager.beginTransaction().replace(R.id.fragmentFrameLayout, mFragment, "registerFragment").commit()
    }
    ...
    fun changeBackButtonState() {
        ...
        backArrow.visibility = if (backArrow.visibility == View.VISIBLE) View.INVISIBLE else View.VISIBLE
    }
